 ...
 * @author JavaHell
 */
public class AnalistaTecnico extends Funcionario {
    
    //Construtor da classe
    public AnalistaTecnico(int id_funcionario, String nome, String cpf, int idade, String cargo, String senha, String sexo){
